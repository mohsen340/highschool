...
<html>
<head>
    <title>لیست کلاس ها|تکالیف</title>
        ...
        <div id="content" class="col-xs-12" >
            <section class="group row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <a href="{{route('teacher-class-homework',1)}}">
                        <article>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <a href="{{route('teacher-class-homework',2)}}">
                        <article>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <a href="{{route('teacher-class-homework',3)}}">
                        <article>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <a href="{{route('teacher-class-homework',4)}}">
                        <article>
